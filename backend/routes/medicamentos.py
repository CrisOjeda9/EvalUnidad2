...
@medicamento.get("/medicamentos/", response_model=List[schemas.medicamentos.Medicamento], tags=["Medicamentos"])
...
@medicamento.put("/medicamento/{ID}", response_model=schemas.medicamentos.Medicamento, tags=["Medicamentos"],)
...
@medicamento.delete("/medicamento/{ID}", response_model=schemas.medicamentos.Medicamento, tags=["Medicamentos"], )
