...
@consumible.get("/consumibles/", response_model=List[schemas.consumibles.Consumible], tags=["Consumibles"])
...
@consumible.get("/consumible/{ID}", response_model=schemas.consumibles.Consumible, tags=["Consumibles"])
...
@consumible.put("/consumible/{ID}", response_model=schemas.consumibles.Consumible, tags=["Consumibles"])
...
@consumible.delete("/consumible/{ID}", response_model=schemas.consumibles.Consumible, tags=["Consumibles"])
